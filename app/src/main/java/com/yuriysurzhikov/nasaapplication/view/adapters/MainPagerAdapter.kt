package com.yuriysurzhikov.nasaapplication.view.adapters
...
class MainPagerAdapter private constructor(fm: FragmentManager, behavior: Int) : FragmentPagerAdapter(fm, behavior) {
